...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0, hv-hashes inconsistent: ff0e71e8cd978373 and 8560392127702a81 found!}
\providecommand{\algname}{MOEAD EGO{}}
\providecommand{\algfolder}{MOEAD_EGO/}
...
%
        ...
        evaluations) divided by the \aRT\ of the best algorithm from BBOB 2016 in #1. The \aRT\ 
...
%
        ...
        %
        Shown is the \aRT\ for fixed values of $\DI = 10^k$ with $k$ given
        in the legend.
...
%
        ...
        divided by the \aRT\ of the best algorithm from BBOB 2016 to reach \ftarget.
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0, hv-hashes inconsistent: ff0e71e8cd978373 and 8560392127702a81 found!}
\providecommand{\algname}{MOEAD SUBSTITUTE{}}
\providecommand{\algfolder}{MOEAD_SUBSTITUTE/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $58$ 
...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v0.0.0, hv-hashes inconsistent: ff0e71e8cd978373 and 8560392127702a81 found!}
\providecommand{\algname}{MOEAD HYBRID{}}
\providecommand{\algfolder}{MOEAD_HYBRID/}
\providecommand{\bbobecdfcaptionallgroups}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of objective function evaluations,
             divided by dimension (FEvals/DIM) for the $58$ 
